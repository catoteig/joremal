...
const errorMapping = [
  { code: 'auth/weak-password', message: 'Passordet må være minst 6 tegn' },
  { code: 'auth/requires-recent-login', message: 'auth/requires-recent-login' },
...
export const errorText = (code: string): string => {
  return errorMapping.find((e) => e.code === code)?.message || 'Ukjent feil'
}
